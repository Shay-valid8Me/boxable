...
/**
 * The <code>LineStyle</code> class defines a basic set of rendering attributes for lines.
 *
 * @author hstimac
 * @author mkuehne
 */
public class LineStyle {
   ...
   * @return new styled line
   */
  public static LineStyle produceDashed(
      final Color color, final int width, final float[] dashArray, final float dashPhase) {
    final LineStyle line = new LineStyle(color, width);

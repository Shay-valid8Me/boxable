...
public final class Tokenizer {
  ...
  private static Stack<Integer> findWrapPointsWithFunction(
      String text, WrappingFunction wrappingFunction) {
  ...
  public static List<Token> tokenize(final String text, final WrappingFunction wrappingFunction) {
    ...
    if (text != null) {
      final Stack<Integer> possibleWrapPoints =
          wrappingFunction == null
              ? findWrapPoints(text)
